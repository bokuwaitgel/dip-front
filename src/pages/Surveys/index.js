  ...
  return (
    <Container>
      ...
      <>
        ...
        <Title>Боломжит судалгаа</Title>
        <SizedBox height="20px"></SizedBox>
        {!openSurveys?.length && (
          <EmptyWarning>
            <VectorContainer src={empty_list} />
            <EmptyWarningText> Идвэхтэй судалгаа байхгүй байна</EmptyWarningText>
          </EmptyWarning>
        )}
        <SurveyGrid>
          {!loading &&
      ...
      {!loading && idleSurveys?.length > 0 && (
        <>
          <SizedBox height="50px"></SizedBox>
          <Title>Бөглүүлэхээр бэлдсэн судалгаанууд</Title>
          <SizedBox height="20px"></SizedBox>
          <SurveyGrid>
      ...
      <>
        <SizedBox height="50px"></SizedBox>
        <Title>Хаагдсан судалгаанууд</Title>
        <SizedBox height="20px"></SizedBox>
        {!closedSurveys?.length && (
          <EmptyWarning>
            <VectorContainer src={empty_list} />
            <EmptyWarningText> Хаагдсан судалгаа байхгүй байна</EmptyWarningText>
          </EmptyWarning>
        )}
        <SurveyGrid>
          {!loading &&
